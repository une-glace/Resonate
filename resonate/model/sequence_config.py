...
CONFIG_16K = SequenceConfig(duration=10, sampling_rate=16000, spectrogram_frame_rate=256)  # !TODO fix sequnce config here -> Latent length = 312
CONFIG_44K = SequenceConfig(duration=10, sampling_rate=44100, spectrogram_frame_rate=512)

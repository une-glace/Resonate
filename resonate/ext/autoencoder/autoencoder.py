...
from resonate.ext.autoencoder.vae import VAE, get_my_vae
from resonate.ext.bigvgan import BigVGAN
from resonate.ext.bigvgan_v2.bigvgan import BigVGAN as BigVGANv2
...
class AutoEncoderModule(nn.Module):
    ...
    def __init__(self,
        ...
        if mode == '16k':
            ...
            self.vocoder = BigVGANv2.from_pretrained('./weights/bigvgan_v2_44khz_128band_512x',
